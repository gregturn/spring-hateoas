...
/**
 * Unit tests for {@link org.springframework.hateoas.mvc.ControllerLinkBuilderFactory}.
 * 
...
public class ControllerLinkBuilderFactoryUnitTest extends TestUtils {
	...
	org.springframework.hateoas.mvc.ControllerLinkBuilderFactory factory = new org.springframework.hateoas.mvc.ControllerLinkBuilderFactory();

	@Test
	public void createsLinkToControllerRoot() {

		Link link = factory.linkTo(ControllerLinkBuilderUnitTest.PersonControllerImpl.class).withSelfRel();
	...
	public void createsLinkToParameterizedControllerRoot() {
		...
		Link link = factory.linkTo(ControllerLinkBuilderUnitTest.PersonsAddressesController.class, 15).withSelfRel();
	...
	public void linksToMethodWithPathVariableContainingBlank() {
		...
		Link link = ControllerLinkBuilder.linkTo(methodOn(ControllerLinkBuilderUnitTest.ControllerWithMethods.class).methodWithPathVariable("with blank")).withSelfRel();
		assertThat(link.getRel(), is(Link.REL_SELF));
	...
	public void createsLinkToParameterizedControllerRootContainingBlank() {
		...
		Link link = factory.linkTo(ControllerLinkBuilderUnitTest.PersonsAddressesController.class, "with blank").withSelfRel();
	...
	public void createsLinkToParameterizedControllerRootWithParameterMap() {
		...
		Link link = factory.linkTo(ControllerLinkBuilderUnitTest.PersonsAddressesController.class, Collections.singletonMap("id", "17")).withSelfRel();
