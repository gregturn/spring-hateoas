...
public class TypeConstrainedMappingJackson2HttpMessageConverterUnitTest {
	...
	public void rejectsNullType() {
		new org.springframework.hateoas.mvc.TypeConstrainedMappingJackson2HttpMessageConverter(null);
	}
	...
	public void canReadTypeIfAssignableToConfiguredType() {
		...
		GenericHttpMessageConverter<Object> converter = new org.springframework.hateoas.mvc.TypeConstrainedMappingJackson2HttpMessageConverter(
