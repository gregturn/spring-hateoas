...
import org.springframework.hateoas.web.mvc.*;
import org.springframework.hateoas.web.mvc.ResourceProcessorHandlerMethodReturnValueHandler;
import org.springframework.hateoas.web.mvc.ResourceProcessorInvoker;
...
public class ResourceProcessorHandlerMethodReturnValueHandlerUnitTests {
	...
	public void usesHeaderLinksResponseEntityIfConfigured() throws Exception {
		...
		org.springframework.hateoas.mvc.ResourceProcessorHandlerMethodReturnValueHandler handler = new org.springframework.hateoas.mvc.ResourceProcessorHandlerMethodReturnValueHandler(
				delegate, new org.springframework.hateoas.mvc.ResourceProcessorInvoker(resourceProcessors));
		handler.setRootLinksAsHeaders(true);
		handler.handleReturnValue(resource, parameter, null, null);

		verify(delegate, times(1)).handleReturnValue(Mockito.any(org.springframework.hateoas.mvc.HeaderLinksResponseEntity.class), eq(parameter),
	...
	public void registersProcessorForProxyType() {
		...
		new org.springframework.hateoas.mvc.ResourceProcessorHandlerMethodReturnValueHandler(delegate, new org.springframework.hateoas.mvc.ResourceProcessorInvoker(resourceProcessors));
	}
	...
	private void invokeReturnValueHandler(String method, Object returnValue, Object expected) throws Exception {
		...
		HandlerMethodReturnValueHandler handler = new org.springframework.hateoas.mvc.ResourceProcessorHandlerMethodReturnValueHandler(delegate,
				new org.springframework.hateoas.mvc.ResourceProcessorInvoker(resourceProcessors));
