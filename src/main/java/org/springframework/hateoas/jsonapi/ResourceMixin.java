 ...
 */
@JsonSerialize(using = Jackson2JsonApiModule.JsonApiResourceSerializer.class)
@JsonDeserialize(using = Jackson2JsonApiModule.JsonApiResourceDeserializer.class)
