 ...
 */
@JsonSerialize(using = Jackson2JsonApiModule.JsonApiResourcesSerializer.class)
@JsonDeserialize(using = Jackson2JsonApiModule.JsonApiResourcesDeserializer.class)
